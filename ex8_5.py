...
# load data
x, Fs = librosa.load('data/mixture_instantaneous.wav', mono=False, sr = 44100) 
x = x.T
...
# sd.play(y[:,0], Fs)
sf.write('ica_source_1.wav', y[:,0], Fs, subtype='PCM_24')

# Play the second component
print('Play ICA estimated source 2')
# sd.play(y[:,1], Fs)
sf.write('ica_source_2.wav', y[:,1], Fs, subtype='PCM_24')
